...
HD_PWD='C:/Users/jakob/PWM_MOD_TEST/PWM_MOD_TEST.runs/PWM_BLOCK_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_BLOCK_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_BLOCK_clk_wiz_0_0.tcl
